...
intentPatterns: "bootstrap (modal|alert|navbar|card|form);;bootstrap (grid|layout|breakpoint|utility class);;responsive layout (with|using) bootstrap;;bootstrap (ui|component|styling)"
---

...
Runs as an **agent team** with Team Lead (delegate mode), audit teammates, and Codex review gates. Follows the same orchestration pattern as `my-experteam-openissues` and `my-flightphp-pro`.
